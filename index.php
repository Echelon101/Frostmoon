<?php
	...
	//aumatic redirect for mobile carriers
...
<html lang="de">
    ...
    ?>
		...
		<?php if(isset($_GET['logout']) || isset($_GET['reset'])){
	    ...
	    <div class="w3-row">
	        ...
	        <div class="w3-col" style="width:80%">
				...
				<?php }?>
			    <div id="content1" class="w3-display-container w3-center">
			        <p>
			        <img src="bilder/Logo.png" width="716" height="300" ALT="Digital Glance Text">
			        </p>
					<p>
			        	<span style="font-size: xx-large;">Herzlich Willkommen auf unserer Seite!</span><br>
		        ...
		        <hr />
		       	<div id="content2" class="w3-display-container w3-center">
			        <p class="w3-justify " style="text-allign: justify;">
		...
		<div class="w3-row">
	        ...
	        <div class="w3-col" style="width:80%">
				<hr />
			    <div id="video1" class="w3-display-container w3-center">
					<h4>Hier etwas zum Anhören von uns:</h4>
					<video id="player" src="videos/music.mp4" width="640" height="480" controls controlsList="nodownload"> </video>
				</div>
			</div>
	    	<div class="w3-col" style="width:10%">
	    		<p></p>
