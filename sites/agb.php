...
<html>
	...
	<?php include '../php/cookiemodal.php';?>
		<script src="../libs/snap/snap.js"></script>
        ...
        <div class="w3-row">
		    ...
		    <div class="w3-col" style="width:60%">    
                <div id="agbs"class='impressum'>
					<h1>Allgemeine Geschäftsbedingungen der Firma JANmusic</h1><br />
					<br />
					...
					(1) Die folgenden Regelungen über den Vertragsabschluss gelten für Bestellungen über unseren Internetshop https://schule.florian-wichert.de .<br />
					<br />
					...
					<b>
					   ...
					   <b>Widerrufsrecht</b><br />
						...
						<div style="margin-left:20px; margin-top: 5px; margin-bottom: 5px;">
							...
							Langelohe 4<br />
							D-25337 Elmshorn<br />
							E-Mail andre.mueller97@outlook.com<br />
										Telefax 04121 47280<br />
								</div>
					...
					****************************************************************************************************
					...
					<a href="documents/Muster_Widerrufsformular_JANmusic.docx" class="w3-button w3-black" download="Muster_Widerrufsformular_JANmusic.docx">Muster_Widerrufsformular zum Herunterladen</a>
					<br />
