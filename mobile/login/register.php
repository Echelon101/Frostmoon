	...
	<?php include '../php/cookiemodal.php';?>
        ...
        <div class="" style="width:100%">
    		<form action="login/register.php?register=1" method="post" class="w3-container w3-center">
    			...
    			<input type="text" size="40" maxlength="250" name="name" placeholder="Max" class="w3-input"><br />
    			<label class="w3-left">Nachname:</label>
    			<input type="text" size="40" maxlength="250" name="sname" placeholder="Mustermann" class="w3-input"><br />
    			...
    			<input type="password" size="40" maxlength="250" name="password2" placeholder="*****" class="w3-input"><br />
